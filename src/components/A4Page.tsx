...
export const A4Page: React.FC<A4PageProps> = ({ children, pageNumber, className }) => {
  return (
    <div 
      className={cn(
        "w-full md:w-[210mm] min-h-auto md:min-h-[297mm] bg-white shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] mx-auto my-4 md:my-12 p-4 md:p-[20mm] relative box-border flex flex-col",
